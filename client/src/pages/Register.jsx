...
const Register = () => {
  ...
  return (
    <div className='bg-gym-darker min-h-screen'>
      <div className='container mx-auto px-6'>
        ...
        >
          ...
          <Link to="/login" className='text-white opacity-85 font-medium' data-aos="fade-in">
            Already a registered user? <span className='underline text-gym-red font-semibold'>Login</span>
          </Link>

          <button 
            type='submit' 
            className='btn px-5 py-2 font-normal outline-none border border-gym-red rounded-sm text-xl text-white bg-gym-red hover:bg-gym-red-dark hover:scale-105 transition-all ease-in w-full max-w-[750px]'
