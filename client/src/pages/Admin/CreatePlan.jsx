...
const CreatePlan = () => {
  ...
  return (
    <section className='py-10 bg-gray-900 min-h-screen'>
      <div className='container mx-auto px-6'>
        <form className='flex w-full min-h-[calc(100vh-8rem)] justify-center items-center flex-col gap-5 py-10' onSubmit={onSubmit}>
