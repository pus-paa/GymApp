...
const Trainer = ({ img, alt, id, name, age }) => {
  ...
  <div className="text-black rounded-xl shadow-lg hover:shadow-xl transition-transform transform hover:scale-105 duration-300 text-center">
      ...
      <div className="p-5 text-center">
        ...
        <div className="mt-1">
          <Link to={`trainer/${id}`} className="mt-4 inline-block bg-gym-red text-white px-6 py-2 rounded-full font-semibold hover:bg-gym-red-dark transition-colors duration-300">
            View Profile
          </Link>
        </div>
      </div>
