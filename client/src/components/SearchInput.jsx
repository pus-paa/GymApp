    ...
    <section className='pt-32 '>
      <div className='px-7 sm:px-14 space-y-12'>
          ...
          <div className='flex flex-row justify-center items-center'>
            ...
            <button className='text-3xl md:text-4xl px-5 text-white bg-gym-red py-[7px] rounded hover:bg-gym-red-dark transition-colors' onClick={handleSearch}><AiOutlineSearch/></button>
          </div>
